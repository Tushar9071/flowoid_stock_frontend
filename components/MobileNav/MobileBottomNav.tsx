...
const NAV_DESCRIPTIONS: Record<string, string> = {
  ...
  'dealer-management': 'Manage dealer accounts',
  'supplier-management': 'Manage supplier accounts',
...
export function MobileBottomNav() {
  ...
  const navConfig = useMemo<{ primaryTabs: NavItem[]; morePages: NavItem[] } | null>(() => {
