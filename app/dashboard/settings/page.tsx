  ...
  return (
    <DashboardLayout title="System Settings" subtitle="Manage your company profile, financial preferences, and system defaults">
      <div className="max-w-4xl space-y-8 pb-8">
        {/* Company Settings */}
        <div className="bg-white rounded-2xl border border-[#e5e7eb] theme-card-accent overflow-hidden">
          <div className="p-6 border-b border-[#e5e7eb] flex items-center gap-3">
            ...
            <div>
              <h3 className="text-[18px] font-bold theme-text-primary">Company Information</h3>
          ...
          <div className="p-6">
            <form onSubmit={e => e.preventDefault()} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input required defaultValue="Ayanshi Imitation" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div>
                <label className="block text-[13px] font-semibold text-[#374151] mb-1.5">Business Type</label>
                <input required defaultValue="Jewellery Manufacturing" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div>
                <label className="block text-[13px] font-semibold text-[#374151] mb-1.5">Email Address</label>
                <input required type="email" defaultValue="info@ayanshi.com" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div>
                <label className="block text-[13px] font-semibold text-[#374151] mb-1.5">Phone Number</label>
                <input required defaultValue="+91 9876543210" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div className="md:col-span-2">
                <label className="block text-[13px] font-semibold text-[#374151] mb-1.5">Registered Address</label>
                <input required defaultValue="Jaipur, Rajasthan" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div className="md:col-span-2 pt-2">
                <button type="submit" className="theme-accent-btn px-5 py-2.5 rounded-lg text-sm font-semibold transition-colors">
                  Save Information
                </button>
              </div>
            </form>
        ...
        <div className="bg-white rounded-2xl border border-[#e5e7eb] theme-card-accent overflow-hidden">
          <div className="p-6 border-b border-[#e5e7eb] flex items-center gap-3">
            ...
            <div>
              <h3 className="text-[18px] font-bold theme-text-primary">Financial Configuration</h3>
          ...
          <div className="p-6">
            <form onSubmit={e => e.preventDefault()} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input required defaultValue="April 1" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div>
                <label className="block text-[13px] font-semibold text-[#374151] mb-1.5">Default Credit Period (Days)</label>
                <input required defaultValue="30" type="number" min="0" className="theme-focus-ring w-full h-10 px-3 rounded-lg border border-[#e5e7eb] text-sm bg-white outline-none transition-all" />
              </div>
              <div className="md:col-span-2 pt-2">
        ...
        <div className="bg-white rounded-2xl border border-[#e5e7eb] theme-card-accent overflow-hidden">
          <div className="p-6 border-b border-[#e5e7eb] flex items-center gap-3">
            ...
            <div>
              <h3 className="text-[18px] font-bold theme-text-primary">System Preferences</h3>
          ...
          <div className="p-6">
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[15px] font-semibold theme-text-primary">Email Notifications</p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[15px] font-semibold theme-text-primary">Automated Backups</p>
        ...
        <div className="bg-[#fff0f0] rounded-2xl border border-[#cc2200]/20 shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <p className="text-[15px] font-bold theme-text-primary">Factory Reset System</p>
