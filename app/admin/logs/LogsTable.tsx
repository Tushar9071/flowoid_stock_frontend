          ...
          <TableHeader>
            <TableRow className="bg-gray-50 border-b border-gray-200">
              ...
              <TableHead
                ...
                filterValues={filters.level ? [filters.level] : []}
                onFilterChange={(vals) => {
                  const val = vals.length > 0 ? vals[vals.length - 1] : undefined;
                  setFilters({ ...filters, level: val, page: 1 });
                }}
              >
                Level
              </TableHead>
              <TableHead
                filterOptions={[
                  ...
                  { label: 'Audit', value: 'db_audit' },
                  { label: 'Backup', value: 'backup' }
                ]}
                filterValues={filters.category ? [filters.category] : []}
                onFilterChange={(vals) => {
                  const val = vals.length > 0 ? vals[vals.length - 1] : undefined;
